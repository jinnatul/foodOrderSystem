module.exports = function(express, app, multer, bodyParser, path, Detail) {
    ...
    var upload = multer({storage: multer.diskStorage({
      ...
      //user show product
      app.get('/foods_user', function(req, res){
        Detail.find({}, function(err,data){
          if(err){
            console.log(err);
          }else{
            res.render('foods_user',{data:data});
          }
        })
